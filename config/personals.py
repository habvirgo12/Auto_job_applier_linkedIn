...
# Your legal name
first_name = "Hasrat"                 # Your first name in quotes Eg: "First", "Hasrat"
# middle_name = "Vignesh"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Ali"                # Your last name in quotes Eg: "Last", "Ali"

# Phone number (required), make sure it's valid.
phone_number = "97430121472"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Doha, Qatar"                  # Los Angeles, San Francisco, etc.
'''
